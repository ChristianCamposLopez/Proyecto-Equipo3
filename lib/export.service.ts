...
export class ExportService {
   ...
   */
  exportToExcel(data: ExportData[], metadata: ExportMetadata): void {
   ...
   */
  exportToPDF(data: ExportData[], metadata: ExportMetadata): void {
    // Crear documento PDF
    const doc = new jsPDF({
   ...
   */
  export(data: ExportData[], metadata: ExportMetadata, format: 'pdf' | 'excel'): void {
    if (format === 'pdf') {
