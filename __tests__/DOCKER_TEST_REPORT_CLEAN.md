...
PASS __tests__/US008-ControlStock.test.ts
  ● Console
    ...
    console.log
      ...
      at Object.<anonymous> (__tests__/US008-ControlStock.test.ts:46:15)

    console.log
        -> Verificando rechazo de stock negativo...

      at Object.<anonymous> (__tests__/US008-ControlStock.test.ts:63:15)

PASS __tests__/US004-DashboardChef.test.ts
  ● Console
    ...
    console.log
      ...
      at Object.<anonymous> (__tests__/US004-DashboardChef.test.ts:64:15)

    console.log
        -> Verificando inicio de preparación de pedido...

      at Object.<anonymous> (__tests__/US004-DashboardChef.test.ts:81:17)
