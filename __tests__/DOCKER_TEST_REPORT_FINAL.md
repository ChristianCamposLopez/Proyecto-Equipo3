FAIL __tests__/US008-ControlStock.test.ts
  ● Console
    ...
    console.log
      ...
      at Object.<anonymous> (__tests__/US008-ControlStock.test.ts:45:15)

    console.log
        -> Verificando rechazo de stock negativo...

      at Object.<anonymous> (__tests__/US008-ControlStock.test.ts:61:15)

  ● US008: Gestión de Menú – Control de Stock › Capa de Persistencia (ProductoDAO.updateStock) › ✓ debe actualizar stock e is_available = true si cantidad > 0
    ...
    - StringMatching /SET stock = \$1,.*is_available = \$2/i,
    + "UPDATE products 
          SET stock = $1, 
              is_available = $2 
          WHERE id = $3",
    ...
    Number of calls: 1
      ...
      36 |       await ProductoDAO.updateStock(1, 10);
      37 |       
    > 38 |       expect(mockQuery).toHaveBeenCalledWith(
         |                         ^
      39 |         expect.stringMatching(/SET stock = \$1,.*is_available = \$2/i),
      40 |         [10, true, 1]
      41 |       );

      at Object.<anonymous> (__tests__/US008-ControlStock.test.ts:38:25)

FAIL __tests__/notas-pedido.old.test.ts
  ● Test suite failed to run
    ...
    > 17 | jest.mock("@/lib/deliveryAddresses", () => ({
      ...
      at Object.<anonymous> (__tests__/notas-pedido.old.test.ts:17:6)

PASS __tests__/US003-DetallePlato.test.ts
  ● Console
    ...
    console.log
      ...
      at Object.<anonymous> (__tests__/US003-DetallePlato.test.ts:45:15)

    console.log
        -> Verificando error de negocio para ID inexistente...

      at Object.<anonymous> (__tests__/US003-DetallePlato.test.ts:69:15)

FAIL __tests__/direccion-entrega.old.test.ts
  ● Test suite failed to run
    ...
    > 14 | import {
      ...
      at createNoMappedModuleFoundError (node_modules/jest-resolve/build/index.js:1117:17)
      at Object.<anonymous> (__tests__/direccion-entrega.old.test.ts:14:1)

FAIL __tests__/carrito-compras.old.test.ts
  ● Test suite failed to run
    ...
    > 16 | import { addItemToCart, updateCartItemQuantity } from "@/lib/cart";
      ...
      at createNoMappedModuleFoundError (node_modules/jest-resolve/build/index.js:1117:17)
      at Object.<anonymous> (__tests__/carrito-compras.old.test.ts:16:1)

PASS __tests__/US005.2-EditarPlato-Integral.test.ts
  ● Console
...
FAIL __tests__/US004-DashboardChef.test.ts
  ...
  ● US004: Eficiencia Operativa – Dashboard del Chef › Capa de Servicios (PedidoService.updateStatus) › ⚠ debe rechazar transiciones de estado inválidas (Lógica de Negocio)
    ...
    Expected substring: "Transición de estado no permitida"
    Received message:   "Cannot read properties of undefined (reading 'rowCount')"

          219 |   static async updateOrderStatus(orderId: number, newStatus: string): Promise<PedidoEntity> {
          220 |     const result = await db.query(`UPDATE orders SET status = $1 WHERE id = $2 RETURNING *`, [newStatus, orderId]);
        > 221 |     if (result.rowCount === 0) throw new Error("No se pudo actualizar el estado");
              |                ^
          222 |     return result.rows[0];
          223 |   }
          224 |

      at Function.updateOrderStatus (models/daos/PedidoDAO.ts:221:16)
      at PedidoService.updateOrderStatus (services/PedidoService.ts:48:12)
      at Object.<anonymous> (__tests__/US004-DashboardChef.test.ts:69:7)
      at Object.toThrow (node_modules/@jest/expect/node_modules/expect/build/index.js:2155:20)
      at Object.<anonymous> (__tests__/US004-DashboardChef.test.ts:70:18)
  ...
  ● US004: Eficiencia Operativa – Dashboard del Chef › Capa de Servicios (PedidoService.updateStatus) › ✓ debe permitir cambiar de PENDING a PREPARING (Camino Feliz)
    ...
    > 221 |     if (result.rowCount === 0) throw new Error("No se pudo actualizar el estado");
      ...
      at Function.updateOrderStatus (models/daos/PedidoDAO.ts:221:16)
      at PedidoService.updateOrderStatus (services/PedidoService.ts:48:12)
      at Object.<anonymous> (__tests__/US004-DashboardChef.test.ts:79:9)

PASS __tests__/us012-historial-ordenes.test.tsx
PASS __tests__/US020.1-RegistrarHorario-integral.test.ts
  ● Console
...
PASS __tests__/US020.2-EditarHorario-integral.test.ts
  ● Console
...
Test Suites: 5 failed, 40 passed, 45 total
Tests:       3 failed, 327 passed, 330 total
Snapshots:   0 total
Time:        5.651 s, estimated 9 s
Ran all test suites.
